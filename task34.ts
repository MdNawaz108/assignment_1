...
var pizzas = ["Chicken Fajeeta", "Chicken Tikka", "pepperoni"];
...
console.log(
  `\nI Like Chicken Fajeeta pizza so much.\nIf i could i will have one every day.\nSimply Pizza is my favorite dish\nI really love pizza!`
);
